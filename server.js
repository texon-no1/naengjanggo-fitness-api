...
각 레시피는 '집에서 만들기 쉬운 수준'으로, 구체적인 재료/조리법이 아니라 '어떤 요리인지'와 '헬스 관점에서 왜 좋은지'를 설명해 주세요.

아래 JSON 배열 형식으로만 출력하세요.

[
  {
    "name": "요리 이름 (최대 20자)",
    "tags": "태그1 · 태그2 (예: 저칼로리·포만감 · 고단백 샐러드)",
    "desc": "간단 설명 (최대 80자, 헬스/다이어트 관점에서 장점 위주)",
    "youtube_query": "유튜브에서 검색하면 좋을 키워드 (예: 닭가슴살 고구마 샐러드 다이어트)"
  },
  ...
]

JSON 이외의 설명 문장은 절대 쓰지 마세요.
  `.trim();
